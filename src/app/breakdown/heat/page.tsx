        ...
        <>
            ...
            <div className="relative text-center">
                <h1 className="text-5xl font-bold relative z-10 inline-block title">
                    <span className="relative z-10 dark:text-gray-200">THE EFFECT OF NEW MEASURES ON HEAT DEMAND</span>
