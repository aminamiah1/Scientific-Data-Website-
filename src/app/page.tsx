      ...
      <div className="my-8 max-w-screen-xl mx-auto px-10 md:px-32">
        ...
        <div className="mt-12">
          <div className="relative text-center">
            <h1 className="text-5xl font-bold relative z-10 inline-block">
          ...
          <table className="table-auto w-full mb-4 bg-gray-100 shadow-md rounded-lg">
            <tbody className="divide-y divide-gray-300">
              ...
              <tr>
                ...
                <td className="px-4 py-3 text-sm text-gray-600">digital curation | supervised machine learning</td>
              </tr>
              <tr>
                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 bg-gray-200">Sample characteristic - Environment</th>
                <td className="px-4 py-3 text-sm text-gray-600">anthropogenic environment</td>
              </tr>
              <tr>
                <th className="px-4 py-3 text-left text-sm font-semibold text-gray-700 bg-gray-200">Sample characteristic - Location</th>
                <td className="px-4 py-3 text-sm text-gray-600">England | Wales </td>
              </tr>
            </tbody>
          </table>
        </div>
